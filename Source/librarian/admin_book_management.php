			...
			<div class="container"style="margin-top:50px; padding-top:20px">
                ...
                <div class="col-md-15">
                        <div class="table-responsive"style="overflow: hidden;">
                            <table id="dtBasicExample" class="table table-sm table-hover table-bordered text-center"style="font-size: 12px;">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form>
                                                    ...
                                                    <!-- <button type="submit" style="margin: -285px; border-radius: 18px; width: 300px" class="btn btn-primary">Submit</button> -->
