		...
		<div class="dashboard-header">
			<div class="container"style="margin-top:50px; padding-top:20px; margin-left: 15px">
				<div class="row">
					<div class="col-md-6">
						<div class="left">
							<p><span>|Etit Book Information</span></p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="right text-right">
							<a href="manage_books_SL.php"><i class="fas fa-home"></i>Back</a>
				...
				<div class="d-flex justify-content-center">
                        <div class="bg-light p-3 " style="width:80%; border-radius: 20px">
							<form class="row g-2" action='inc/edit_bookfunction.php' method= 'POST'>
